  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        p5: {
          red: "hsl(var(--p5-red))",
          "red-deep": "hsl(var(--p5-red-deep))",
          black: "hsl(var(--p5-black))",
          ink: "hsl(var(--p5-ink))",
          bone: "hsl(var(--p5-bone))",
          yellow: "hsl(var(--p5-yellow))",
        },
      },
      keyframes: {
        ...
        "menu-in": {
          "0%": { transform: "translateX(-60px) skewX(-12deg)", opacity: "0" },
      ...
      animation: {
        ...
        "slash-wipe": "slash-wipe 0.9s cubic-bezier(0.65,0,0.35,1) both",
        "menu-in": "menu-in 0.45s cubic-bezier(0.22,1,0.36,1) both",
